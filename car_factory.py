...
class CarFactory():
    def create_calliope(self, current_mileage, last_service_mileage, last_service_date, current_date):
        return Car(CapuletEngine(current_mileage, last_service_mileage), SpindlerBattery(last_service_date, current_date))

    def create_glissade(self, current_mileage, last_service_mileage, last_service_date, current_date):
    ...
    def create_rorschach(self, current_mileage, last_service_mileage, last_service_date, current_date):
        return Car(WilloughbyEngine(current_mileage, last_service_mileage), NubbinBattery(last_service_date, current_date))

    def create_thovex(self, current_mileage, last_service_mileage, last_service_date, current_date):
